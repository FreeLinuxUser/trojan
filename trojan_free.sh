...
if [ $real_addr == $local_addr ] ; then
	...
	wget https://raw.githubusercontent.com/FreeLinuxUser/trojan/master/web.zip
    	unzip web.zip
	...
	if test -s /usr/src/trojan-cert/fullchain.cer; then
        cd /usr/src
	wget https://github.com/FreeLinuxUser/trojan/raw/master/trojan-1.13.0-linux-amd64.tar.xz
	tar xf trojan-1.*
	#下载trojan客户端
	wget https://github.com/FreeLinuxUser/trojan/raw/master/trojan-cli.zip
